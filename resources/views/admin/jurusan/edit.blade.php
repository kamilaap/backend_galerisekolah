...
@extends('layouts.app', ['title' => 'Edit Jurusan - Admin'])
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6 bg-gradient-to-r from-blue-600 to-blue-800 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold text-white">Edit Jurusan</h2>
            ...
            <!-- Form -->
            <form action="{{ route('admin.jurusan.update', $jurusan->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $jurusan->nama) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition-colors" required>
                        @error('nama')
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="deskripsi" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition-colors" required>{{ old('deskripsi', $jurusan->deskrispi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
