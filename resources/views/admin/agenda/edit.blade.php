...
capitalize">EDIT Agenda</h2>
            <hr class="mt-4">
            <form action="{{ route('admin.agenda.update',
$agenda->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                     ...
                     <!-- Kategori -->
                     <div>
                        <label class="text-gray-700" for="kategori_id">AGENDA</label>
