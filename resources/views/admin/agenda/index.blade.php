    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-green-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.agenda.create') }}">TAMBAH</a>
            </button>
                ...
                <table class="w-auto table-auto">
                    <thead class="justify-between">
                        <tr class="bg-green-600">
                            <th class="px-4 py-2" style="width: 15%">
                                <span class="text-white">JUDUL AGENDA</span>
                            </th>
                            ...
                            <th class="px-4 py-2 text-left" style="width: 10%">
                                <span class="text-white">TANGGAL AGENDA</span>
                            </th>
                            <th class="px-4 py-2 text-left" style="width: 10%">
                            ...
                            <th class="px-4 py-2 text-center" style="width: 10%">
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            ...
                            <td class="px-4 py-2">
                                {{ \Carbon\Carbon::parse($agenda->tanggal_post_agenda)->format('d M Y') }}
                            </td>
                            <td class="px-4 py-2">
                                {{ ucfirst($agenda->status) }}
                            </td>
                            <td class="px-4 py-2 text-center">
                                <a href="{{ route('admin.agenda.edit', $agenda->id) }}" class="bg-indigo-600 px-2 py-1 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                                <button onClick="destroy(this.id)" id="{{ $agenda->id }}" class="bg-red-600 px-2 py-1 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
