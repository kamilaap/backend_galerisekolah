        ...
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-green-600">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $informasi }}</h4>
                            <div class="text-white">INFORMASI</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-green-600">
                        <div class="p-3 rounded-full bg-indigo-600 bg-opacity-75">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1
                                    1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"></path>
                            </svg>
                        </div>
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $galery }}</h4>
                            <div class="text-white">GALERY</div>
                        </div>
                    </div>
                </div>
                <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-green-600">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $agenda }}</h4>
