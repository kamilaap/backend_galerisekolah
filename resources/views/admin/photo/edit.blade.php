@extends('layouts.app', ['title' => 'Edit Photo - Admin'])
@section('content')
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold
capitalize">EDIT PHOTO</h2>
            <hr class="mt-4">
            <form action="{{ route('admin.photo.update',
$photo->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 gap-6 mt-4">
                    <!-- Judul Photo -->
                    <div>
                        <label class="text-gray-700" for="judul">JUDUL PHOTO</label>
                     ...
                     <!-- Galery -->
                     <di>
                        <label class="text-gray-700" for="galery_id">GALERY</label>
                        <select name="galery_id" class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" required>
