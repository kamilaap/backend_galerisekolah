    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-green-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.photo.create') }}">TAMBAH</a>
            </button>
                ...
                <table class="min-w-full table-auto">
                    <thead class="justify-between bg-green-600">
                        <tr>
                            ...
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">GALERY</span>
                            </th>
                            <th class="px-16 py-2">
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            ...
                            <td class="px-4 py-2">
                                <img src="{{$photo->image }}" alt="{{ $photo->judul }}" class="w-16 h-16 object-cover" />
                            </td>
                            <td class="px-4 py-2">
                                {{ $photo->galery->judul }}
                            </td>
                            <td class="px-4 py-2 text-center">
                                <a href="{{ route('admin.photo.edit', $photo->id) }}" class="bg-indigo-600 px-2 py-1 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                                <button onClick="destroy(this.id)" id="{{ $photo->id }}" class="bg-red-600 px-2 py-1 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
