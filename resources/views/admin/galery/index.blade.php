    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-green-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.galery.create') }}">TAMBAH</a>
            </button>
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border-b bg-white">
                            ...
                            <td class="px-4 py-2 text-center">
                                <a href="{{ route('admin.galery.edit', $galery->id) }}" class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="bg-red-500 text-white text-center p-3 rounded-sm shadow-md">
                                Data Belum Tersedia!
                            </td>
                        </tr>
                        @endforelse
