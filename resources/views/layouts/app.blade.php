...
179.2 332.8C179.2 352.456 186.698 372.109 201.694 387.105Z"
                    ...
                    <span class="text-white text-2xl mx-2 font-semibold">Galery Sekolah</span>
                </div>
            </div>
            <hr>
            <nav class="mt-5">
                <a class="flex items-center mt-4 py-2 px-6 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/dashboard*') ? '
...
01-2-2v-2z">
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/kategori*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}"
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/informasi*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}"
                    href="{{
...
24 24"
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/agenda*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}" href="{{
route('admin.agenda.index') }}">
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/galery*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}" href="{{
route('admin.galery.index') }}">
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/photo*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}" href="{{
                ...
                <div class="flex items-center">
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <button @click="dropdownOpen = !dropdownOpen" class="relative block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none">
                            <img class="h-full w-full object-cover" src="{{ auth()->user()->avatar }}" alt="Profile Avatar">
                        </button>
